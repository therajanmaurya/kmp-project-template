...
// module-deps.gradle.kts — the FORK-OWNED dependency seam for `core/common` (white-label).
//
// `core/common/build.gradle.kts` is template-owned and FULL-COPIES on `/kmp-project-template-sync`.
